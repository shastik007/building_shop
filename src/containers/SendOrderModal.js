...
const SendOrderModal = ({isOpen,onClose}) => {
  ...
  return (
    <Modal onClose={onClose} title="Обратная связь"  isOpen={isOpen}>
      <InputsWrapper>
         <Input value={data.fullName} name="fullName" onChange={changeHandler} label="ФИО" />
       </InputsWrapper>
       <InputsWrapper>
         <Input value={data.phoneNumber} name="phoneNumber" onChange={changeHandler} label="Номер"/>
       </InputsWrapper> 
       <ActionsWrapper>
           <ButtonWrapper>
